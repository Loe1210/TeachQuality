...
public class MajorEvaluationProcessInfo {
    ...
    @ApiModelProperty("查看权限 0为负责人/院长 可以查看所有专家 专家组长 的全部评审 1为评审专家 只能查看自己的评审 2为评审专家组长 可以查看全部专家评审")
    ...
    public MajorEvaluationProcessInfo() {
